...
@Component({
  selector: 'app-paginador-contribucion-derechos-g',
  templateUrl: './paginador-contribucion-derechos-g.component.html',
  styleUrls: ['./paginador-contribucion-derechos-g.component.css']
})
export class PaginadorContribucionDerechosGComponent implements OnInit {
