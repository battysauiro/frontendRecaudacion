...
@Component({
  selector: 'app-paginador-contribucion-derechos-licencias',
  templateUrl: './paginador-contribucion-derechos-licencias.component.html',
  styleUrls: ['./paginador-contribucion-derechos-licencias.component.css']
})
export class PaginadorContribucionDerechosLicenciasComponent implements OnInit {
