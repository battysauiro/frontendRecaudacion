...
@Component({
  selector: 'app-paginador-contribucion-multas',
  templateUrl: './paginador-contribucion-multas.component.html',
  styleUrls: ['./paginador-contribucion-multas.component.css']
})
export class PaginadorContribucionMultasComponent implements OnInit {
