...
@Component({
  selector: 'app-paginador-contribucion-otros-productos',
  templateUrl: './paginador-contribucion-otros-productos.component.html',
  styleUrls: ['./paginador-contribucion-otros-productos.component.css']
})
export class PaginadorContribucionOtrosProductosComponent implements OnInit {
