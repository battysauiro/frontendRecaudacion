...
@Component({
  selector: 'app-paginador-impuestos',
  templateUrl: './paginador-impuestos.component.html',
  styleUrls: ['./paginador-impuestos.component.css']
})
export class PaginadorImpuestosComponent implements OnInit {
