...
@Component({
  selector: 'app-paginador-contribucion-multas-ebriedad',
  templateUrl: './paginador-contribucion-multas-ebriedad.component.html',
  styleUrls: ['./paginador-contribucion-multas-ebriedad.component.css']
})
export class PaginadorContribucionMultasEbriedadComponent implements OnInit {
